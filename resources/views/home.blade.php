...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="/datadiri" data-toggle="" data-target="#collapsePages"
            ...
            <div class="sidebar-card d-none d-lg-flex">
                ...
                <p class="text-center mb-2"><strong>INGATLAH!</strong> untuk selalu menjaga kesehatan dimanapun anda berada</p>
            </div>
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                Lokasi Terakhir</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">Lokasi Terakhir: <br>Surabaya</div>
                                        </div>
                                        <div class="col-auto">
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card border-left-info shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1"><a href="/datadiri">Isi Data Diri</a>
                                            </div>
                                            <div class="row no-gutters align-items-center">
                                                <div class="col-auto">
                                                ...
                                                <span>Silahkan Lengkapi Data Diri Anda</span>
                                            </div>
                                        </div>
                                        <div class="col-auto">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
                                                <a href="/catatan">Catatan Perjalanan</a></div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">Melakukan Perjalanan ke beberapa Kota</div>
                                        </div>
                                        <div class="col-auto">
