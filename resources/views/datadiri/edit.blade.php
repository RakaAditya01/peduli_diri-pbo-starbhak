                ...
                <div class="card-body" style="width: 90%">
                    <form  method="POST" action="/updatedata/{{$data->id}}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="jenis_kelamin" value="{{$data->jenis_kelamin}}" class="form-control" id=""
                                aria-describedby="emailHelp">
                            <div id="emailHelp" class="form-text"></div>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="no_ponsel" value="{{$data->no_ponsel}}" class="form-control" id=""
                                aria-describedby="emailHelp">
                            <div id="emailHelp" class="form-text"></div>
                        </div>
